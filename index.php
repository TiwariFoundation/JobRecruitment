  ...
  <div class="navbar-inner">
    <div class="container"> 
      ...
      <div class="nav-collapse index">
		...
		<span id="signinbtn"><button id="loginbtn" class="btn btn-primary" onclick="signin()" disabled>Welcome 
	...
	<div class="row">
	  <div class="span6 third-section-span-1">
		<div class="third-section-text" style="text-align:left;">
		  <p class="third-section-text-md">The best way to find a professional
